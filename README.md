...
- This branch is **obsolete**. The Christmas version has been reworked into the Christmas theme in regular Sneky (see [Themes](https://github.com/gamingwithevets/sneky#themes) in `README.md` of branch `main`).
